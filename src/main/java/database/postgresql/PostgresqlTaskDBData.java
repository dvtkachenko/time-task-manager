 ...
 */
public class PostgresqlTaskDBData implements TaskDBAction {
    ...
    public boolean addUserTask(TaskData taskData)  throws SQLException {
        ...
        if (psAddUserTask == null) {
            psAddUserTask = getDbConnection().prepareStatement(PostgresqlSQLStatement.Tasks.addUserTask);
        }
    ...
    public boolean deleteUserTask(TaskData taskData) throws SQLException {
        ...
        if (psDeleteUserTask == null) {
            psDeleteUserTask = getDbConnection().prepareStatement(PostgresqlSQLStatement.Tasks.deleteUserTask);
        }
    ...
    public boolean deleteUserAllTasks(int userID) throws SQLException {
        ...
        if (psDeleteUserAllTasks == null) {
            psDeleteUserAllTasks = getDbConnection().prepareStatement(PostgresqlSQLStatement.Tasks.deleteUserAllTasks);
        }
    ...
    public boolean updateUserTask(TaskData taskData) throws SQLException {
        ...
        if (getDbConnection() == null) throw new SQLException(DBMessage.NO_DB_CONNECTION);
        if (psAddUserTask == null) {
            psUpdateUserTask = getDbConnection().prepareStatement(PostgresqlSQLStatement.Tasks.updateUserTask);
        }
    ...
    public TaskData getUserTask(TaskData taskData) throws SQLException {
        ...
        if (psGetUserTask == null) {
            psGetUserTask = getDbConnection().prepareStatement(PostgresqlSQLStatement.Tasks.getUserTask);
        }
    ...
    public List<TaskData> getUserAllTasks(int userID) throws SQLException {
        ...
        if (psGetUserAllTasks == null) {
            psGetUserAllTasks = getDbConnection().prepareStatement(PostgresqlSQLStatement.Tasks.getUserAllTasks);
        }
    ...
    public List<TaskData> getUserAllTasksAsTree(int userID, int nodeID) throws SQLException {
        ...
        if (psGetUserAllTasksAsTree == null) {
            psGetUserAllTasksAsTree = getDbConnection().prepareStatement(PostgresqlSQLStatement.Tasks.getUserAllTasksAsTree);
        }
