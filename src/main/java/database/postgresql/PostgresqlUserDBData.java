...
public class PostgresqlUserDBData implements UserDBAction {
    ...
    public boolean addUser(UserData userData) throws SQLException {
        ...
        if (psAddUser == null) {
            psAddUser = getDbConnection().prepareStatement(PostgresqlSQLStatement.Users.addUser);
        }
    ...
    public boolean deleteUser(UserData userData) throws SQLException {
        ...
        if (psDeleteUser == null) {
            psDeleteUser = getDbConnection().prepareStatement(PostgresqlSQLStatement.Users.deleteUser);
        }
    ...
    public boolean changePassword(UserData userData) throws SQLException {
        ...
        if (psChangePassword == null) {
            psChangePassword = getDbConnection().prepareStatement(PostgresqlSQLStatement.Users.changePassword);
        }
    ...
    public UserData getUserData(UserData userData) throws SQLException {
        ...
        if (psGetUserData == null) {
            psGetUserData = getDbConnection().prepareStatement(PostgresqlSQLStatement.Users.getUserData);
        }
...
//        }
    ...
    public List<UserData> getAllUsersData() throws SQLException {
        ...
        if (psAllUsersData == null) {
            psAllUsersData = getDbConnection().prepareStatement(PostgresqlSQLStatement.Users.getAllUsersData);
        }
